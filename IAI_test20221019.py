...
def MovePos():
    ...
    data = FiftymmPos#FiftymmPos#MOVE_LOC5
    for i in data:
        serial_port.write(bytearray(i, 'ascii'))
    # data = CurrentPos
    # for i in data:
...
class MainFrame(tk.Frame):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.button.place(x=0.5, y=0.5, anchor=tk.CENTER)
        ...
        self.label.pack(side="left",pady=12, padx=10)
        ...
        #self.entry.grid(row=3, column=0, columnspan=1, padx=20, pady=10, sticky="w")
        self.entry.pack(side="left",pady=12, padx=10)
        ...
        self.buttonMove.pack(padx=20, pady=10)
